...
# compute the disparity map using the block matching algorithm without using the OpenCV function
...
#calculate the 3d 3D point cloud
def compute_3d_point_cloud(disparity_map, cam0, baseline):
    """
    Compute the 3D point cloud from the disparity map.
